...
| 12 | Cloud deployment security/recovery/monitoring | Partial | Container, Railway manifest, permanent IAC/PERSONAL database profile binding, health gate, migrations, backup/restore drill, deterministic alert classification, scope-bound non-delivering route plans, production drill plan | Live alert delivery, encrypted production backup/restore evidence, least privilege, and drill execution require Sean approval |
