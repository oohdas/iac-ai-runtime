...
| 12 | Cloud deployment security/recovery/monitoring | Partial | Container, Railway manifest, permanent IAC/PERSONAL database profile binding, health gate, migrations, backup/restore drill, checklist | Actual separately owned environment, secrets, persistent storage, alerts, encryption, least privilege require Sean deployment approval |
